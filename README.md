...
| Vista | Descripción |
|-------|--------------|
| **Login** | Permite el ingreso al sistema con un usuario simulado. |
| **Lista de productos** | Muestra todos los productos registrados. |
| **Agregar producto** | Formulario para registrar un nuevo producto. |
| **Editar producto** | Permite actualizar los datos de un producto existente. |
| **Detalle de producto** | Muestra información detallada del producto seleccionado. |
...
| Tecnología | Uso |
|-------------|-----|
| **Laravel (Blade)** | Estructura del proyecto y manejo de rutas. |
...
2. Abre XAMPP y enciende **Apache** y **MySQL** (si lo usas).
3. Desde una terminal, entra a la carpeta del proyecto:
   ```bash
   cd C:\xampp\htdocs\Pescaderia